...
type mockConstructorTestingTnewMockDebugModeRegistry interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockDebugModeRegistry(t mockConstructorTestingTnewMockDebugModeRegistry) *mockDebugModeRegistry {
