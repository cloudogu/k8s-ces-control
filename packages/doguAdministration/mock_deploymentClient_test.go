...
type mockConstructorTestingTnewMockDeploymentClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockDeploymentClient(t mockConstructorTestingTnewMockDeploymentClient) *mockDeploymentClient {
